...
def unet_model_3d(first_input_shape, second_input_shape, nb_classes, feature_size):
    ...
    base_model = NASNetMobile(weights=None,include_top = False,input_shape=[128,128,3])
    base_model.load_weights('/home/mdd/.keras/models/nasnet_mobile_no_top.h5',by_name=True)
